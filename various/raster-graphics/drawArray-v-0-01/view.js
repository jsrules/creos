...
function draw() {
    ...
    /*
    for (let x = 0; x < img2picWidth / 1; x++) {
        // saved[x] = []
        // img2pic += '['
        for (let y = 0; y < img2picHeight / 1; y++) {
            // const element = array[index];
            //   const data = context.getImageData(x, y, 1, 1).data;
            const RED = img2pic[x][y][0]
            const GREEN = img2pic[x][y][1]
            const BLUE = img2pic[x][y][2]
            const ALPHA = 255//data[3]
            ...
            dot(x + img1picWidth, y, r, g, b, alfa) 
