...
function draw() {
    ...
    let r = grayValue//randomInteger(0, 255)
    let g = grayValue//randomInteger(0, 255)  //randomInteger(0, 255)
    let b = grayValue//randomInteger(0, 255)
    let alfa = 255
    
    for (let index = 0; index < 1000; index++) {
        // const element = array[index];
        let x = randomInteger(0, END_X-1)
        let y = randomInteger(0, END_Y-1)
        dot(x, y, r, g, b, alfa) 
