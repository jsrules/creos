...
function draw() {
    ...
    //rg rb gb
    let r = currGRAYcolor // rgbArr.r//randomInteger(0, 255)
    let g = currGRAYcolor// rgbArr.g //currGreen + 1 //  currGreen < 255 ? currGreen + 1 : 0  //randomInteger(0, 255)  //randomInteger(0, 255)
    // currGreen = g
    let b = currGRAYcolor//rgbArr.b//randomInteger(0, 255)
    let alfa = 255
    ...
    //ggr ggb grb gbg rgg bgg
    //bbr bbr brb bgb rbb gbb
    // let r = rgbArr.g//randomInteger(0, 255)
