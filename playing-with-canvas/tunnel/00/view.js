...
function draw() {
    ...
    for (let f = -2 * Math.PI; f <= 1 * Math.PI; f += STEP_POLAR_COORDINATES /* +coef_1 */) {  //0
        ...
        dot(polarCoordsCalculateX(R, f) + getHalfWidth(),  /* coef_1*  */   polarCoordsCalculateY(R, f) + getHalfHeight(), /* color: */ randomInteger(0,255), randomInteger(0,255), randomInteger(0,255));
