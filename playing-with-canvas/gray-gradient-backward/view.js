...
function draw() {
   ...
   let  rgbArr = hexToRgb(currRGBcolorStr);
    ...
    let r =   currGRAYcolor//rgbArr.g//randomInteger(0, 255)
    let g = currGRAYcolor//rgbArr.b //currGreen + 1 //  currGreen < 255 ? currGreen + 1 : 0  //randomInteger(0, 255)  //randomInteger(0, 255)
    // currGreen = g
    let b = currGRAYcolor//rgbArr.r//randomInteger(0, 255)
    let alfa = 255
