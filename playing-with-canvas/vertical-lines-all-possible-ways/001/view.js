...
function draw() {
    ...
    let r = grayShade;////randomInteger(0,255);;//grayShade;//randomInteger(0,255);
    let g =grayShade;// randomInteger(0,255);//grayShade;//randomInteger(0,255);
    let b =grayShade;// randomInteger(0,255);//grayShade;//randomInteger(0,255);
    ...
    // let r = randomInteger(0,255);;//grayShade;//randomInteger(0,255);
    // let g = randomInteger(0,255);//grayShade;//randomInteger(0,255);
    // let b = randomInteger(0,255);//grayShade;//randomInteger(0,255);
    let alfa = 255;//randomInteger(0,255);


    // ctx.ellipse(getHalfWidth(), getHalfHeight(), 100, 200, 0, 0, Math.PI*2 );

    ctx.beginPath();
    ctx.strokeStyle =  "rgba(" + r + "," + g + "," + b + "," + (alfa / 255) + ")";
ctx.ellipse(getHalfWidth(), getHalfHeight(), ellipseR1, ellipseR2, Math.PI / 2, 0, 2 * Math.PI);
ctx.stroke();

grayShade--
ellipseR1++
ellipseR2=ellipseR1*2
  return
    ...
    for (let f = -2 * Math.PI; f <= 1 * Math.PI; f += STEP_POLAR_COORDINATES /* +coef_1 */) {  //0
        ...
        // let R = L; // L / (1 -  (ellipseE*Math.cos(f))  );
